...
public class MonsterMakerWindow : EditorWindow
{
    ...
    {
        // 실제로 AI 애셋들이 있는 폴더(Assets/MonsterSettings/AI)와 일치시킨다. 예전에 여기가
        // "Assets/Monsters/AI"였는데 폴더가 옮겨지면서 안 맞춰져 있었고, 그 결과 FindAssets가
        // 기존 애셋을 항상 못 찾아 매번 새 애셋(중복 guid)을 만들어내고 있었다.
        string folder = "Assets/MonsterSettings/AI";
